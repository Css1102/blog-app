        ...
        <Container>
          <div className="flex flex-wrap">
            ...
            <img className='rounded-xl md:object-cover h-[60%] w-[50%] mb-2 md:h-[60%] md:w-[30%] flex relative left-[60px] md:left-1/3 md:mb-10' src={cricimg} alt="" />
              ...
              <br/>
              <button className='md:text-xl text-lg rounded-full px-2 py-1 mt-4 z-50 font-prec text-slate-200 w-[120px] h-[40px] bg-[rgb(78,51,235)] inline-block mr-6 hover:opacity-80 shadow-md transition duration-200 cursor-pointer'><Link className=' cursor-pointer drop-shadow-md'
              to='/login'>Login Now</Link></button>
            </div>
            <h3 className="md:text-3xl text-base font-normal md:font-semibold relative md:left-[30%] font-playwrite text-slate-100 hover:text-primary transition duration-200 mt-20">ON THIS DAY:11/09/2023</h3>
          <h4 className="mt-5 text-sm font-normal md:left-32 left-[0px] md:top-20 md:ml-10 xl:top-20 xl:mr-80 xl:ml-10 xl:left-44  md:text-xl md:font-medium text-slate-100 relative hover:text-primary transition duration-200">Virat Kohli, KL Rahul and Kuldeep Yadav craft India's biggest win vs Pakistan
